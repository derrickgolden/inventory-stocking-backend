...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->routes(function () {
            ...
            Route::middleware('counter')
                ->prefix('counter')
                ->group(base_path('routes/counterRoutes.php'));
            Route::middleware('restock-counter')
                ->prefix('restock-counter')
                ->group(base_path('routes/restockCounterRoutes.php'));
